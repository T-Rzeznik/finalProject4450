  ...
  while (flag) {
    ...
    switch (choice) {
      case 1:
        ...
        break;
      case 2:
        const id1 = await askQuestion("Enter the room ID: ");
        await getRoomById(id1);

        break;
      case 3:
        const data3 = await askQuestion("Enter room data (JSON format): ");
        await createRoom(JSON.parse(data3));
        break;
      case 4:
        const id4 = await askQuestion("Enter the room ID:");
        const data = await askQuestion("Enter data in JSON format:");
        await updateRoomById(id4, JSON.parse(data));
        break;
      case 5:
        const id2 = await askQuestion("Enter the room ID: ");
